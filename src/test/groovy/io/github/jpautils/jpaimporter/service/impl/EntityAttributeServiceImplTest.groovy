...
class EntityAttributeServiceImplTest extends Specification {
    ...
    def 'should return correct EntityAttributeValueDto for referenced value when #testDescription'() {
        ...
        ' "null" '      | null                      | ['null']                      | null                          | true          | referencedEntityMock  | null                                          | 'parsed value is null in double quotes'
        ' val1    '     | null                      | ['val1']                      | null                          | true          | referencedEntityMock  | null                                          | 'parsed value is a value with blank space before and after'
        ' "val1"  '     | null                      | ['val1']                      | null                          | true          | referencedEntityMock  | null                                          | 'parsed value is a value in double quotes with blank space before and after double quotes'
        'val1 val2'     | null                      | ['val1', 'val2']              | null                          | true          | referencedEntityMock  | null                                          | 'parsed value references another entity by 2 attributes'
        ' "val1 val2" ' | null                      | ['val1', 'val2']              | null                          | true          | referencedEntityMock  | null                                          | 'parsed value references another entity by 2 attributes that are in double quotes'
        ' "val1 @ref" ' | null                      | ['val1', entityMock]          | null                          | true          | referencedEntityMock  | null                                          | 'parsed value references another entity by 2 attributes one of which is a reference from the context'
        ' @ref @ref '   | null                      | [entityMock, entityMock]      | null                          | true          | referencedEntityMock  | null                                          | 'parsed value references another entity by 2 attributes both of which are references from the context'
        ' @ref null '   | null                      | [entityMock, 'null']          | null                          | true          | referencedEntityMock  | null                                          | 'parsed value references another entity by 2 attributes one of which is a reference from the context and the second is the string null'
        null            | ['@ref abc', 'abc null']  | [entityMock, 'abc']           | ['abc', 'null']               | true          | null                  | [referencedEntityMock, referencedEntityMock]  | 'parsed value list are 2 items that each reference another entity by 2 fields that also contain references from context'
        null            | ['"@ref a"', '"abc nu"']  | [entityMock, 'a']             | ['abc', 'nu']                 | true          | null                  | [referencedEntityMock, referencedEntityMock]  | 'parsed value list are 2 items in double quotes that each reference another entity by 2 fields that also contain references from context'
        null            | ['@ref', 'abc']           | [entityMock]                  | ['abc']                       | true          | null                  | [referencedEntityMock, referencedEntityMock]  | 'parsed value list are 2 items that each reference another entity and the items might contain a context reference'
        null            | ['null', '"null"']        | ['null']                      | null                          | true          | null                  | [null, referencedEntityMock]                  | 'parsed value list are 2 items that each reference another entity and the values are null with and without double quotes'
        null            | ['abc']                   | ['abc']                       | null                          | true          | null                  | [referencedEntityMock]                        | 'parsed value list contains one item'
        null            | []                        | null                          | null                          | true          | null                  | []                                            | 'parsed value list is an empty list'
    }
